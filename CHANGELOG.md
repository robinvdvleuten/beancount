...
- serve interactive editor through `web` command ([#45](https://github.com/orhun/git-cliff/issues/45)) - ([7a58980](https://github.com/robinvdvleuten/beancount/commit/7a589805c6fad05accecc19b634969891eed0192))
...
- *(test)* standardize assertions to assert - ([c8e1a32](https://github.com/robinvdvleuten/beancount/commit/c8e1a32d6817787350f16122727a6d50218a0300))
- *(formatter)* add constants for magic numbers - ([75004d9](https://github.com/robinvdvleuten/beancount/commit/75004d93d6985a983a0a45117a26557924f78c32))
- *(formatter)* extract helper for source line preservation - ([9d40111](https://github.com/robinvdvleuten/beancount/commit/9d401113460d87d9946f5193e26c4562ab86bcaa))
- *(loader)* merge duplicate loadRecursive functions - ([a393479](https://github.com/robinvdvleuten/beancount/commit/a39347919c789e58aa858d12e122d62eb8c7093b))
- *(ledger)* remove unused context from validation funcs - ([79ac605](https://github.com/robinvdvleuten/beancount/commit/79ac60502a5b5f12174a69a4b61cbb41b34af51c))
- *(ledger)* move total cost validation to validator - ([9794d23](https://github.com/robinvdvleuten/beancount/commit/9794d2377102ce8b2355840c2fd47dfe90dc7574))
- eliminate string parsing anti-patterns in telemetry - ([b2007bb](https://github.com/robinvdvleuten/beancount/commit/b2007bb272cbde28a49f3816a34c96dd5cd077a4))

### Documentation

- remove orphaned comment from README - ([979ef90](https://github.com/robinvdvleuten/beancount/commit/979ef901145b6796ad2ddfac46e38ac211015b16))
- *(agents)* document error wrapping strategy - ([2517eef](https://github.com/robinvdvleuten/beancount/commit/2517eefbeb7f2515b4ccf7d70183d9e8c6116484))
- *(telemetry)* document timer concurrency constraints - ([2e543a4](https://github.com/robinvdvleuten/beancount/commit/2e543a47d2476772d1a6b75b9e545ddc038b273a))
- remove reference to participle - ([6cfc1ff](https://github.com/robinvdvleuten/beancount/commit/6cfc1ffea8274143fd7ab8f1a6f3438d3619c3e7))
...
- replaced participle with a custom recursive descent parser ([#43](https://github.com/orhun/git-cliff/issues/43)) - ([85d9ba2](https://github.com/robinvdvleuten/beancount/commit/85d9ba23a7927339ab7da499d7f6fb47b409e8be))
...
- move main to root for simpler go install - ([768a964](https://github.com/robinvdvleuten/beancount/commit/768a964205d519c74414846431fe3966b9c3dd82))
- use strings.Builder instead of += - ([4828a2f](https://github.com/robinvdvleuten/beancount/commit/4828a2f9aa384f8ae4e3d4b63e07f9fa5311abf2))
- *(ledger)* separate validation from applying - ([7fee479](https://github.com/robinvdvleuten/beancount/commit/7fee479c827715db7d6fa7985fcb5f8df037786e))
- *(parser)* use AST builders in tests - ([f1f69fe](https://github.com/robinvdvleuten/beancount/commit/f1f69fe713b459290f5e299ecba0f2c36bce743a))

### Documentation

- add compatibility section to readme [skip ci] - ([8668389](https://github.com/robinvdvleuten/beancount/commit/86683898d4437762fa5b60c2af57be374d48d6e0))
- add image to README.md - ([af0b45e](https://github.com/robinvdvleuten/beancount/commit/af0b45e73539e08e5e9ab5940b510a5f71289246))
- document validation flow - ([62e531e](https://github.com/robinvdvleuten/beancount/commit/62e531ed63d82b573cd0d51e717709b356cbb42a))
...
- *(examples)* add CSV importer with usage guide - ([7badd54](https://github.com/robinvdvleuten/beancount/commit/7badd54905f7b8fa2771271d7a7a2d79656d5146))
- add comments to packages - ([2362465](https://github.com/robinvdvleuten/beancount/commit/236246574148cf28ea9c879fdebd483320df8fd0))
- update README.md - ([d21e933](https://github.com/robinvdvleuten/beancount/commit/d21e9337ceb2ba8a3b64a04a21320e85d1d32aa5))
...
- initial ledger functionality ([#42](https://github.com/orhun/git-cliff/issues/42)) - ([fd495c6](https://github.com/robinvdvleuten/beancount/commit/fd495c6b761a517f0ff685e61dcb53ff2d212396))
...
- add descriptions to all parser types - ([306568d](https://github.com/robinvdvleuten/beancount/commit/306568dc1c163ed635ec7f0d22a4c62398f1d299))
- add license to README - ([4c168cc](https://github.com/robinvdvleuten/beancount/commit/4c168ccd0baffde17cf4170c95c35595211eb7bb))
- update readme - ([7e37634](https://github.com/robinvdvleuten/beancount/commit/7e37634c0f54e3a664d9d13501c6133e7546fc65))
...
- add support for formatting beancount files ([#41](https://github.com/orhun/git-cliff/issues/41)) - ([aefe473](https://github.com/robinvdvleuten/beancount/commit/aefe47372db68c942d3348d8b6f30ae56ad51d16))
...
- add support for links in transactions ([#40](https://github.com/orhun/git-cliff/issues/40)) - ([5975259](https://github.com/robinvdvleuten/beancount/commit/59752596c0740c29e50b10aab3d2eb1d3d1b4e14))
